...
public class MainActivity extends AppCompatActivity implements FragmentLista.OnArticuloSeleccionadoListener {
    ...
    public void mostrarDetalle(Articulo articuloSeleccionado) {
        FragmentoDetalle detalleFragment = (FragmentoDetalle) getSupportFragmentManager()
                .findFragmentById(R.id.contenedorDetalle);
